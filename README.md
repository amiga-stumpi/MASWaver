...
MASRadio opens `amitls13.library` only for `https://` playlist entries. If the library is missing, MASRadio shows a clear install message and leaves normal `http://` streaming unchanged.
